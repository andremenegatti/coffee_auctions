...
# Abrindo bases ---------------------------------------------------------------
dd_data_list <- c('ajustes-marcas/dd_brasil_main13.rds', 'ajustes-marcas/dd_sp_main13.rds') %>% 
...
stargazer(df_models_sp$felm_models, type = 'text',
          out = 'ajustes-marcas/results/log-win-bid-sp.txt')

stargazer(df_models_sp$felm_models,
          out = 'ajustes-marcas/results/log-win-bid-sp.tex',
...
# Salvando dados
df_models_sp %>% 
  saveRDS('ajustes-marcas/results/log-win-bid-sp.rds')
