...
# Marcas
marcas <- readRDS('ajustes-marcas/controles_marcas_main13.rds') %>%
  select(id_item, marca_vencedor = marca_vencedor_clean_final,
         marca_vencedor_principais)

# CNPJ vencedor (Comprasnet)
cnpj_vencedores <- readRDS('ajustes-marcas/controles_marcas_main13.rds') %>% 
...
# Salvando
saveRDS(bec_cafe, 'ajustes-marcas/bec_cafe_dd_main13.rds')
saveRDS(cnet_cafe, 'ajustes-marcas/cnet_cafe_dd_main13.rds')
saveRDS(cnet_cafe_sp, 'ajustes-marcas/cnet_sp_cafe_dd_main13.rds')