...
cnet_cafe <- readRDS('Comprasnet/cnet_cafe_01_v4.rds') %>%
  ...
  rename(municipio = municipio_uasg)
...
# 4) EF marca + EF municipio
m4_bec <- lm(win_bid ~ marca_vencedor_principais + municipio, data = BEC_cafe_1st_stage)
BEC_cafe_1st_stage$res_m4 <- m4_bec$residuals

m4_cnet <- lm(win_bid ~ marca_vencedor_principais + municipio, data = cnet_cafe_1st_stage)
cnet_cafe_1st_stage$res_m4 <- m4_cnet$residuals

m4_cnet_sp <- lm(win_bid ~ marca_vencedor_principais + municipio, data = sp_cnet_cafe_1st_stage)
...
stargazer(dd_win_bid_bimestre,
          dd_res_m4_bimestre,
          dd_res_m4_bimestre_futuro,
          dd_res_m4_bimestre_cepea,
          dd_res_m4_bimestre_full,
