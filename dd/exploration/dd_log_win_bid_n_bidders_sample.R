...
stargazer(df_models_sp$felm_models, type = 'text',
          out = 'results/log_win_bid/n_bidders_sample/sp.txt')

stargazer(df_models_sp$felm_models,
          out = 'results/log_win_bid/n_bidders_sample/sp_latex.txt',
...
# Salvando dados
saveRDS(df_models_sp, 'results/log_win_bid/n_bidders_sample/main_results_sp.rds')
...
stargazer(df_models_brasil$felm_models, type = 'text',
          out = 'results/log_win_bid/n_bidders_sample/brasil.txt')

stargazer(df_models_brasil$felm_models,
          out = 'results/log_win_bid/n_bidders_sample/brasil_latex.txt',
          decimal.mark = ',', digit.separator = '.')
...
saveRDS(df_models_brasil,
        'results/log_win_bid/n_bidders_sample/main_results_brasil.rds')
