...
dd_sp <- readRDS('DD/Placebo/base_dd_sp.rds')
...
saveRDS(df_plot_post, 'DD/Placebo/df_placebo_plot_post_sp.rds')
...
ggplot(mapping = aes(x = data_placebo, group = grupo)) +
  ...
  labs(
    ...
    # 3) As ?reas sombreadas representam intervalos de confian?a de 95% (erros padr?o HC1)'
  )


ggsave('C:/Users/Dell/Desktop/placebo_3s_post_sp.png', width = 9, height = 6)
